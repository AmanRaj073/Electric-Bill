...
if (res) {
  ...
  let cstmId = prompt("Enter Customer Id (Any Random No.)");
  let unit = Number(prompt("Enter Unit You have Consumed (Any Random Number )"));
  ...
  document.getElementById("show").innerHTML = `
    ...
    <ul>
   <p>If bill exceeds Rs. 400 then a surcharge of 15% will be charged.</p>
   <p>The minimum bill should be of Rs. 100/- .</p>
    `;
} else {
